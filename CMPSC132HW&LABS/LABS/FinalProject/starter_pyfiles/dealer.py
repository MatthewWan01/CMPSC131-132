...
class Dealer(Player):
    ...
    def __init__(self):
        ...
        super().__init__("Dealer", None) #call player intializer

        self.deck = CardDeck() #create deck
    ...
    def shuffle_deck(self):
        ...
        self.deck.shuffle() #call card shuffle
    ...
    def signal_hit(self, player):
        ...
        [10]
        """
        player.deal_to(self.deck.draw()) #deal card drew to player
    ...
    def play_round(self):
        ...
        [10, 8]
        """
        while self.card_sum < 17: #while dealer hand is 16 or less
            
            self.signal_hit(self) #hit
